...
For server (backend):
 ...
 - Ensure the MySQL server is open under port 3306 & match login information in the .env file. [Note - Basic functionality remains with no DB Server. It allows for information to be saved.]
